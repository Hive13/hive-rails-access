...
(function() {
  ...
  getPasswordStrength = function(password) {
    var char, dump, nonSpecialsCount, passCharArray, passwordLength, passwordLengthScore, passwordScore, specialCharsRegString, specialScore, specialsCount, testValue, uppercaseScore, _i, _j, _len, _len1;
    ...
    nonSpecialsCount = 0;
    for (_j = 0, _len1 = passCharArray.length; _j < _len1; _j++) {
